...
class FixedRateLoan(Loan):
    ...
    def to_dict(self):
        return {'Type': 'Fixed Rate Loan', 'Asset': str(self.asset),
                'Asset Value': self.asset.initialvalue, 'Rate': self.rate,'Term': self.term}
...
class VariableRateLoan(Loan):
    ...
    def to_dict(self):
        return {'Type': 'Variable Rate Loan', 'Asset': str(self.asset),
                'Asset Value': self.asset.initialvalue, 'Rate': self.rateDict,'Term': self.term}
...
class FixedAutoLoan(FixedRateLoan):
    ...
    def to_dict(self):
        return {'Type': 'Fixed Auto Loan', 'Asset': str(self.asset),
                'Asset Value': self.asset.initialvalue, 'Rate': self.rate, 'Term': self.term}
